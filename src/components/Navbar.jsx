  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between gap-6">
        ...
        <a
          href="#home"
          className={`flex items-center gap-2.5 font-bold text-lg flex-shrink-0 font-display ${
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            ...
            <AnimatePresence>
              {themeOpen && (
                <motion.div
                  className={`absolute right-0 top-12 w-44 rounded-xl shadow-2xl border overflow-hidden p-2 flex flex-col gap-1 ${
          ...
          >
            <i className={`fas ${menuOpen ? 'fa-times' : 'fa-bars'} text-xs`} />
          </button>
        </div>
      </div>
